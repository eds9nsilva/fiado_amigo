...
export function ShopAdd({ size = 20, color = 'black' }: IconBase) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M6.48999 18.98H3.51001" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
        stroke-linejoin="round" />
      <Path d="M5 17.52V20.51" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
        stroke-linejoin="round" />
    </Svg>
  );
}
