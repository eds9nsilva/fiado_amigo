...
export function EyeOff({ size = 20, color = 'black' }: IconBase) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            />
            <Path
                d="M15.5099 12.7C15.2499 14.11 14.0999 15.26 12.6899 15.52" stroke={color} stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round"
            />
            <Path
                d="M9.47 14.53L2 22" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
            />
            <Path
                d="M22 2L14.53 9.47"stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </Svg>
    );
}
